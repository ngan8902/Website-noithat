  ...
  return (
    <footer className="bg-dark text-white py-4">
      <div className="container text-center">
        ...
        {/* Contact Information */}
        <p className="mb-1"> <i className="bi bi-geo-alt-fill me-2"></i>Địa chỉ: 20 Nguyễn Văn Bảo, Phường 1, Quận Gò Vấp, TP. Hồ Chí Minh</p>
        <p className="mb-1"> <i className="bi bi-telephone-fill me-2"></i>Số điện thoại: 0585675418</p>
